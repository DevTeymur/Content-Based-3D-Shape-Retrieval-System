...
def get_resampled_filenames(object_path):
    resampled_dir="ShapeDatabase_resampled"
    object_path = Path(object_path)
    filenames = [(object_path / f) for f in os.listdir(directory_name) if f.endswith(('.obj', '.ply', '.stl'))] 
